...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  TombFtmLPTShareRewardPool: {
    name: 'Stake 3OMB-wFTM |4| 3SHARES',
    poolId: 0,
    sectionInUI: 2,
  ...
  TwoombTwosharesLPTShareRewardPool: {
    name: 'NEW OPTION COMING SOON!!! ***Stake 3OMB-3SHARES |4| 3SHARES***',
    poolId: 4,
    sectionInUI: 2,
