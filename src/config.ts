...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  TwoombFtmLPTShareRewardPool: {
    ...
    poolId: 3,
    sectionInAF: 'TwoombFtmLPTShareRewardPool',
    depositTokenName: '2OMB-WFTM LP',
    earnTokenName: '3SHARES',
    finished: false,
    multiplier: '1>WAAAAAAAAAAA',
    buyLink: 'https://spookyswap.finance/add/FTM/0x7a6e4e3cc2ac9924605dca4ba31d1831c84b44ae',
    site: 'https://2omb.finance',
    sort: 11,
    closedForStaking: false,
  ...
  // },
  Tomb2SHARESRebates: {
    name: 'Provide 2SHARES, earn 3OMB',
    poolId: 0,
    sectionInUI: 1,
  ...
  Tomb2SHARESFTMRebates: {
    name: 'Provide 2SHARES-WFTM LP, earn 3OMB',
    poolId: 1,
    sectionInUI: 3,
    contract: 'TombFtmRewardPool',
    depositTokenName: '2SHARES-WFTM LP',
