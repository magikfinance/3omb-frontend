...
const configurations: { [env: string]: Configuration } = {
  production: {
    ...
    externalTokens: {
      ...
      'wFTM': ['0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83', 18],
      'PHOENIX': ['0x87a5C9B60A3aaf1064006FE64285018e50e0d020', 18],
      'PHOENIX-2SHARES LP': ['0x4d6b28441c8B293A603243431E6E31F3C2632ddD', 18],
      'PHOENIX-WFTM LP': ['0xDc71A6160322ad78DaB0abb47C7A581cFE9709Ee',18],
      'MSHARES-WFTM LP': ['0x392C85cECcf9855986b0044a365A5532aeC6Fa31',18],
      'MSHARES': ['0xc54A1684fD1bef1f077a336E6be4Bd9a3096a6Ca', 18],
      'PSHARES-WFTM LP': ['0xd352daC95a91AfeFb112DBBB3463ccfA5EC15b65',18],
      'PSHARES': ['0x6437ADAC543583C4b31Bf0323A0870430F5CC2e7', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  //   name: 'Earn PHOENIX by staking PHOENIX-2SHARES LP',
  //   poolId: 2,
  //   sectionInUI: 0,
  //   contract: 'Tomb2Shares2ombLPRewardPool',
  //   depositTokenName: 'PHOENIX-2SHARES LP',
  ...
  Tomb2ombWftmLPRewardPool: {
    name: 'Earn PHOENIX by staking PHOENIX-BUSD LP',
    poolId: 2,
    sectionInUI: 0,
    contract: 'Tomb2ombWftmLPRewardPool',
    depositTokenName: 'PHOENIX-BUSD LP',
    earnTokenName: 'PHOENIX',
    finished: false,
    multiplier: '6000x',
    site: "https://2omb.finance",
  ...
  Tomb2ombRewardPool: {
    name: 'Earn PHOENIX by staking PHOENIX',
    poolId: 3,
    sectionInUI: 0,
    contract: 'Tomb2ombRewardPool',
    depositTokenName: 'PHOENIX',
    earnTokenName: 'PHOENIX',
    finished: false,
    multiplier: '5000x',
    site: 'https://2omb.finance',
  ...
  //   name: 'Earn PHOENIX by staking BELUGA',
  //   poolId: 4,
  //   sectionInUI: 0,
  ...
  // },
  // TombBifiRewardPool: {
  //   name: 'Earn PHOENIX by staking BIFI',
  //   poolId: 5,
  //   sectionInUI: 0,
  ...
  TombWrappedFtmRewardPool: {
    name: 'Earn PHOENIX by staking BUSD',
    poolId: 6,
    sectionInUI: 0,
  ...
  TombMimRewardPool: {
    name: 'Earn PHOENIX by staking BNB',
    poolId: 7,
    sectionInUI: 0,
  ...
  // TombBloomRewardPool: {
  //   name: 'Earn PHOENIX by staking BLOOM',
  //   poolId: 8,
  //   sectionInUI: 0,
  ...
  TombFtmLPTShareRewardPool: {
    name: 'Earn PSHARES by PSHARES | FTM',
    poolId: 0,
    sectionInUI: 2,
  ...
  TshareFtmLPTShareRewardPool: {
    name: 'Earn PSHARES by PSHARES-BUSD LP',
    poolId: 1,
    sectionInUI: 2,
    contract: 'TshareFtmLPTShareRewardPool',
    depositTokenName: 'PSHARES-BUSD LP',
    earnTokenName: 'PSHARES',
    finished: false,
    multiplier: '24000x',
  ...
  TwoombFtmLPTShareRewardPool: {
    name: 'Earn PSHARES by PHOENIX-BUSD LP',
    poolId: 3,
    sectionInUI: 2,
  ...
  //   name: 'Earn 3SHARES by PHOENIX-2SHARES LP',
  //   poolId: 4,
  //   sectionInUI: 2,
  //   contract: 'TwoombTwosharesLPTShareRewardPool',
  //   depositTokenName: 'PHOENIX-2SHARESLP',
  ...
  //    closedForStaking: false,
  // },
  // Tomb2PHOENIXFTMRebates: {
  //   name: 'Bond PHOENIX-WFTM LP, earn PHOENIX',
  //   poolId: 3,
  //   sectionInUI: 3,
  //   contract: 'TombFtmRewardPool',
  ...
  //Tomb3SHARESFTMRebates: {
   // name: 'Bond 3SHARES-WFTM LP, earn PHOENIX',
   // poolId: 5,
   // sectionInUI: 3,
  //  contract: 'TombFtmRewardPool',
